...
//  Q) 카드 N개를 구매하는 방법은?
//
//  카드 1개가 들어있는 카드팩을 구매하고, 카드 N-1개를 구매
//  카드 2개가 들어있는 카드팩을 구매하고, 카드 N-2개를 구매
//  ...
//  카드 N-1개가 들어있는 카드팩을 구매하고, 카드 1개를 구매
//  카드 N개가 들어있는 카드팩을 구매하고, 카드 0개를 구매
//--------------------------------------------------------------------------------
//  D[N] = max(memo[N],  p[i]              +            memo[N-i] ) (1 <= j <= N)
//                       ㄴ 카드 i개가 들어 있는 카드팩을 구매   ㄴ 카드 N-i개를 구매
public class Main {
